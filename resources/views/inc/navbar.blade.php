        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <li class='nav-item dropdown'>
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    <a href="/Dashboard/members" class="nav-link dropdown-item">{{ __('List Members') }}</a>
                    <a href="/Dashboard/roles" class="nav-link dropdown-item">{{ __('Roles') }}</a>
                </div>
            </ul>
            @endif
            ...
            <ul class="navbar-nav ml-auto">
                ...
                @guest
                    <li><a class="nav-link" href="{{ route('login') }}"><i class="fa fa-sign-in"></i> {{ __('Login') }}</a></li>
