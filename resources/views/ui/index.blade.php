@extends('ui.layout.ui')


@section('headerBG'){{ asset("img/bg.jpeg") }}@endsection
@section('headerText')<h1>CarrotApps</h1><h3>Creative Business Solutions</h3>@endsection
@section('content')

<div class="main main-raised">
  <div class="section section-basic">
    <div class="container">
    {{-- MAIN SECTION STARTING 3DIVS --}}
        <div class="title">
    ...
    <div class="section section-navbars cd-section" id="navigation">
      ...
      <!--             navbar -->
      <div id="navbar">
        <div class="navigation-example" style="background-image: url('{{ asset('/img//bg.jpg') }}');">
      ...
      <div class="container tim-container">
        ...
        <div id="images">
          ...
          <div class="row">
            <div class="col-sm-2">
              <h4>Rounded Image</h4>
              <img src="{{ asset('img/faces/avatar.jpg') }}" alt="Rounded Image" class="rounded img-fluid">
            </div>
            ...
            <div class="col-sm-2 ml-auto">
              ...
              <img src="{{ asset('img/faces/avatar.jpg') }}" alt="Raised Image" class="img-raised rounded img-fluid">
            </div>
            <div class="col-sm-2 ml-auto">
              <h4>Circle Raised</h4>
